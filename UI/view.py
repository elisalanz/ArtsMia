...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        row1 = ft.Row([ft.Container(self._btnAnalizzaOggetti, width = 250), ft.Container(self._txtIdOggetto, width = 250), ft.Container(self._btnCompConnessa, width = 250)], alignment=ft.MainAxisAlignment.CENTER)
